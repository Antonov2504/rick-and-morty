...
export const CustomInput = ({
  ...
  return (
    <Styled.Field $variant={variant} $size={size} $radius={radius} $hasError={!!error} $withIcon={!!withIcon}>
      {!!label && <Styled.Label htmlFor={id} required={!!required}>{label}</Styled.Label>}
