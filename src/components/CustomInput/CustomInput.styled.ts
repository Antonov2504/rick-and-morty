...
import IconSVG from '@src/assets/icons/icon-at.svg';
...
export const Field = styled.div<{ $variant: VariantTypes; $size: SizeTypes; $radius: SizeTypes; $hasError: boolean; $withIcon: boolean }>`
  display: flex;
