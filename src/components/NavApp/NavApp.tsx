...
const CharactersPages = lazy(() => import('@pages/CharactersPages').then((module) => ({ default: module.CharactersPages })));
const EpisodesPages = lazy(() => import('@pages/EpisodesPages').then((module) => ({ default: module.EpisodesPages })));
const LocationsPages = lazy(() => import('@pages/LocationsPages').then((module) => ({ default: module.LocationsPages })));
